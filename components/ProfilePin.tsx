...
export default function ProfilePin() {
    return (
        <div className="p-2 m-2 h-56 rounded-lg border-2 border-gray-800/5 bg-gray-100">
            <div className="w-full h-36 bg-gray-200 rounded-lg" id="workPreview"></div>
            ...
            <div className="flex flex-row mt-4 gap-2" id="workInformation">
                ...
                <div className="flex items-end flex-col flex-1" id="right">
                    <div className="rounded bg-gray-800/10 px-2 py-1" id="medium">
